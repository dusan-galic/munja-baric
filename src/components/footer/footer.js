    ...
    return (
        <div className="container-fluid footer_d">
            ...
            <div className="text-center p-3 autor">
                ...
                target="_blank"
                rel="noreferrer">
                <img className = "ikon" src={process.env.PUBLIC_URL + "/in.svg"}  alt="dusanln" height="30px" width="30px" />
                </a>
                ...
                target="_blank"
                rel="noreferrer">
                 <img className = "ikon" src={process.env.PUBLIC_URL + "/in.svg"} alt="marinaln" height="30px" width="30px" />
                </a>
                О.Г.<a className="text-dark" 
                href="https://www.instagram.com/ognjenngalic/"
                target="_blank"
                rel="noreferrer">
                <img className = "ikon" src={process.env.PUBLIC_URL + "/instagram.svg"} alt="ognjeninstagram" height="30px" width="30px" />
                </a>
            </div>
            </footer>
        </div>
